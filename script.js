...
function hideAllScreens() {
  ...
  document.getElementById("round-detail-screen").style.display = "none";
}
    ...
    name => {
      ...
      html +=
        `<tr>
          ...
          <td>
            ${settlementSign}${totalSettlement.toFixed(0)}円
          </td>
  ...
  reversedHistory.forEach(
    (game, reversedIndex) => {
      ...
      if (
        ...
        html +=
          `<button
            onclick="showRoundDetails(${historyIndex})">
...
function showRoundDetails(historyIndex) {
